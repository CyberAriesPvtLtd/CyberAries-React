...
function ServiceSingle() {
  ...
  return (
    <div>
      <title>Service Details — CyberAries Pvt Ltd</title>
      <link rel="icon" href="images/icon.webp" type="image/gif" sizes="16x16" />
      <meta content="text/html;charset=utf-8" httpEquiv="Content-Type" />
      <meta content="width=device-width, initial-scale=1.0" name="viewport" />
      <meta content="Comprehensive cybersecurity service details and features." name="description" />
                  ...
                  <div className="row g-4 gx-5">
                    <div className="col-lg-6">
                      <div className="relative">
                        <img src="images/misc/s1.webp" className="img-fluid rounded-1 wow fadeInUp" alt="Cybersecurity service visualization" />
                        <div className="bg-color text-light p-4 absolute start-10 w-80 mt-min-70 rounded-1 sm-hide">
                          <p className="no-bottom">Robust protection measures for your critical digital infrastructure.</p>
                        </div>
                      </div>
                    </div>
                    <div className="col-lg-6">
                      <h2>Protect your organization from cyber threats</h2>
                      <p>In today’s hyperconnected digital landscape, your network is the lifeline of your business. We provide robust, multi-layered network security solutions designed to safeguard your data, systems, and operations.</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="container">
            <div className="row gx-5">
              <div className="col-lg-4 col-sm-6">
                ...
                <p>At CyberAries, we’re committed to delivering professional, high-quality cybersecurity solutions.</p>
          ...
          <div className="subfooter">
            <div className="container">
              <div className="de-flex">
                <div className="de-flex-col">© 2026 – CyberAries Pvt Ltd. All Rights Reserved.</div>
