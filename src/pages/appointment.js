...
function Appointment() {
    return (
        <div>
                                ...
                                <div className="col-lg-12">
                                    <div className="d-flex justify-content-between xs-hide">
                                        <div className="d-flex">
                                            ...
                                            <div className="topbar-widget me-3">
                                                <a href="/"><i className="icofont-phone" />+91 8828495202</a>
                                            </div>
                                            <div className="topbar-widget me-3">
                                ...
                                <div className="de-flex sm-pt10">
                                    <div className="de-flex-col">
                                        <div id="logo">
                                            <a href="/">
                                                ...
                                                <img className="logo-mobile" src="images/logo-white.webp" alt="Cyber Aries Logo" />
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div className="de-flex-col">
                                        <div className="menu_side_area">
                                            <a href="/appointment" className="btn-main fx-slide">
                                    ...
                                    <div className="relative">
                                        ...
                                        <form name="bookingForm" id="booking_form" className="relative z1000 bg-light rounded-1 p-40" method="post" action="https://docs.google.com/forms/d/e/1FAIpQLSdCFuDARkRQbPWw-7RnDEhLW5uUz11Ncx4QbAPxak3nS-TA-Q/formResponse" target="gform-target">
                                            <div className="row g-3">
                                                <div className="col-lg-12">
                                                    <h2 className="mb-3"><i className="fa fa-shield id-color me-2" /> Book a Free Consultation</h2>
                                                    ...
                                                    <div className="relative">
                                                        <select name="entry.2100516128" id="service" className="form-control" defaultValue="">
                                                            <option disabled value="">Select Cybersecurity Service</option>
                                                ...
                                                <div className="col-lg-6">
                                                    <div className="relative">
                                                        <select name="entry.355360033" id="time" className="form-control" defaultValue="">
                                                ...
                                                <div className="col-lg-12">
                                                    <div className="relative">
                                                        <select name="entry.985637526" id="referrer" className="form-control" defaultValue="">
                                                            <option disabled value="">How did you hear about CyberAries?</option>
                                                ...
                                                <div className="col-lg-12">
                                                    <div id="submit">
                                                        <input type="submit" id="send_message" value="Send Appointment" className="btn-main" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div id="cy_modal" style={{ display: 'none', position: 'fixed', inset: 0, alignItems: 'center', justifyContent: 'center', background: 'rgba(0,0,0,.6)', zIndex: 9999 }}>
                                                <div style={{ background: '#0b1221', color: '#fff', padding: 20, borderRadius: 10, maxWidth: 520, margin: 'auto' }}>
                                                    ...
                                                    <div id="cy_modal_msg" style={{ opacity: '.9', marginBottom: 10 }}>Thanks — your request has been recorded.</div>
                                                    <div style={{ display: 'flex', gap: 8 }}>
                                                        <a id="cy_modal_ics" href="/" download="cyberaries-event.ics" style={{ background: '#0b5bd7', color: '#fff', padding: '8px 12px', borderRadius: 8, textDecoration: 'none' }}>Add to Calendar</a>
                                                        <a id="cy_modal_wa" href="/" target="_blank" style={{ background: '#25D366', color: '#062b12', padding: '8px 12px', borderRadius: 8, textDecoration: 'none' }}>Confirm on WhatsApp</a>
                                                        <button type="button" id="cy_modal_close" style={{ marginLeft: 'auto', background: 'transparent', border: '1px solid rgba(255,255,255,.12)', color: '#fff', padding: '8px 12px', borderRadius: 8 }}>Close</button>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <iframe id="gform-target" name="gform-target" title="Google Form Submission Target" style={{ display: 'none' }} />
        </div>
    );
}
