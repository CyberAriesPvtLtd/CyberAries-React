            ...
            <div className="container">
              <div className="row g-4">
                <div className="col-lg-6">
                  ...
                  <p className="mb-0">Whether you have a question, a suggestion, or just want to say hello, please fill out the form below and we'll get back to you as soon as possible.</p>
                </div>
                <div className="clearfix" />
                <div className="col-lg-6">
                  <div className="rounded-1 bg-light overflow-hidden">
                    <div className="row g-2">
                      <div className="col-sm-6">
                        <div className="auto-height relative" style={{backgroundImage: "url(images/misc/s1.webp)", backgroundSize: 'cover'}} />
                      </div>
            ...
            <div className="row gx-5">
              <div className="col-lg-4 col-sm-6">
                ...
                <div className="social-icons mb-sm-30">
                  <a href="/" aria-label="LinkedIn"><i className="fa-brands fa-linkedin fa-lg" /></a>
                  <a href="/" aria-label="X (Twitter)"><i className="fa-brands fa-x-twitter fa-lg" /></a>
                  <a href="/" aria-label="Facebook"><i className="fa-brands fa-facebook fa-lg" /></a>
                  <a href="/" aria-label="Instagram"><i className="fa-brands fa-instagram fa-lg" /></a>
                  <a href="/" aria-label="WhatsApp"><i className="fa-brands fa-whatsapp" /></a>
                  <a href="/" aria-label="Blogger"><i className="fa-brands fa-blogger fa-lg" /></a>
                </div>
              </div>
